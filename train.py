...
def get_dataset(args):
    ...
    if args.calc_pos_neg:
        ...
        for i in range(len(train_dataset)):
            sentence, img_feat, label_confidence, label_start, label_end, _ = train_dataset[i]
...
def train(epoch, model, optimizer, train_loader, bm_mask, num_pos_neg, args):
    ...
    for train_iter, data in enumerate(train_loader):
        sentence, img_feat, label_confidence, label_start, label_end, _ = data
        ...
        confidence_map, start, end, _ = model(img_feat)
